...
public class VO_AttendanceHRRowImpl extends ViewRowImpl
{
  ...
  /**
   * Gets the attribute value for the calculated attribute ExceptionApproved.
   * @return the ExceptionApproved
   */
  public String getExceptionApproved()
  {
    return (String) getAttributeInternal(EXCEPTIONAPPROVED)==null?"":getAttributeInternal(EXCEPTIONAPPROVED)=="Y"?"Approved":"Disapproved";
  }

  /**
   * Sets <code>value</code> as the attribute value for the calculated attribute ExceptionApproved.
